...
//Put end state check here
	...
	if($ElectoralVotes >= 270 || $Locked == 50 ){
		...
		//Player 3 did not exist so check for player 1
...
if($rownum > 0){
	...
	$sql = "SELECT donations FROM final WHERE id = 3";
	$result2 = send_sql($sql, $link, $db);
	//Will not work
	...
	$donations = mysql_fetch_array($result2);
...
if($AdLevel > 0){
	if($donations >= $cost){
		...
		$sqlUD = "UPDATE final SET donations = donations - $cost WHERE id = 3";
		...
		if($adlevel > 10){
			...
			if($adlevel == 20){
				echo"You have been refunded 1000 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 1000 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 19){
				echo"You have been refunded 900 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 900 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 18){
				echo"You have been refunded 800 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 800 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 17){
				echo"You have been refunded 700 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 700 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 16){
				echo"You have been refunded 600 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 600 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 15){
				echo"You have been refunded 500 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 500 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 14){
				echo"You have been refunded 400 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 400 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 13){
				echo"You have been refunded 300 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 300 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 12){
				echo"You have been refunded 200 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 200 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 11){
				echo"You have been refunded 100 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 100 WHERE id = 3";
						$UD = send_sql($sqlUD, $link, $db);
...
echo'<script type="text/javascript">
  ...
  document.location.href = "player4.php";
});
...
//otherwise player 1's turn
	...
	$sql = "SELECT donations FROM final WHERE player_name = '$playername'";
	$result = send_sql($sql, $link, $db);
...
echo "</table>";
		...
		$sql = "SELECT player_name FROM final WHERE id=3";
		$playername = send_sql($sql, $link, $db);
