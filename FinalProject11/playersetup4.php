...
if (isset($_POST['Submit'])){
  ...
  //Deciding turn order
	...
	if ($thirdplayer == $player4){
		$statethree = $state4;
	}
	
	if ($fourthplayer == $player1){
		$statefour = $state1;
	}
	if ($fourthplayer == $player2){
		$statefour = $state2;
	}
	if ($fourthplayer == $player3){
		$statefour = $state3;
	}
	if ($fourthplayer == $player4){
		$statefour = $state4;
	}
...
$sql4= "INSERT INTO final (id, player_name, donations, num_locked, cur_state, home_state) VALUES ('$id4', '$fourthplayer', '$donations', 0, '$statefour', '$statefour')";
$result = send_sql($sql, $link, $database);
$result2 = send_sql($sql2, $link, $database);
$result3 = send_sql($sql3, $link, $database);
$result4 = send_sql($sql4, $link, $database);
...
if ($result){
	...
	echo"The player to go fourth is $fourthplayer <br>";
	...
	$sql4 = "CREATE table $fourthplayer (state_id INT(6), state_ab VARCHAR(2), stateinfluence INT(100), state_ad INT(10), locked_in VARCHAR(3))";
	$result = send_sql($sql, $link, $database);
	$result2 = send_sql($sql2, $link, $database);
	$result3 = send_sql($sql3, $link, $database);
	$result4 = send_sql($sql4, $link, $database);
	...
	$sql = "INSERT INTO $firstplayer (state_id, state_ab, stateinfluence, state_ad, locked_in) VALUES (1, 'AL', 0, 1, 'no')";
	$result = send_sql($sql, $link, $database);
...
while($row = mysql_fetch_array($result)){
	...
	$sql = "INSERT INTO $secondplayer (state_id, state_ab, stateinfluence, state_ad, locked_in) VALUES (1, 'AL', 0, 1, 'no')";
	$result = send_sql($sql, $link, $database);
...
// Updating third player with states and current values. 
	$sql = "INSERT INTO $thirdplayer (state_id, state_ab, stateinfluence, state_ad, locked_in) VALUES (1, 'AL', 0, 1, 'no')";
	$result = send_sql($sql, $link, $database);
...
echo"</table>";
	...
	// Updating fourth player with states and current values. 
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad, locked_in) VALUES (1, 'AL', 0, 1, 'no')";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (2, 'AK', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (3, 'AZ', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (4, 'AR', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (5, 'CA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (6, 'CO', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (7, 'CT', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (8, 'DE', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (9, 'FL', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (10, 'GA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (11, 'HI', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (12, 'ID', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (13, 'IN', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (14, 'IA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (15, 'KS', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (16, 'KY', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (17, 'LA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (18, 'ME', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (19, 'MD', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (20, 'MA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (21, 'MI', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (22, 'MN', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (23, 'MS', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (24, 'MO', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (25, 'MT', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (26, 'NE', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (27, 'NV', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (28, 'NH', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (29, 'NJ', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (30, 'NM', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (31, 'NY', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (32, 'NC', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (33, 'ND', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (34, 'OH', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (35, 'OK', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (36, 'OR', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (37, 'PA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (38, 'RI', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (39, 'SC', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (40, 'SD', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (41, 'TN', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (42, 'TX', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (43, 'UT', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (44, 'VT', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (45, 'VA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (46, 'WA', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (47, 'WV', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (48, 'WI', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (49, 'WY', 0, 1)";
	$result = send_sql($sql, $link, $database);
	$sql = "INSERT INTO $fourthplayer (state_id, state_ab, stateinfluence, state_ad) VALUES (50, 'IL', 0, 1)";
	$result = send_sql($sql, $link, $database);
	
	$sql = "UPDATE $fourthplayer SET stateinfluence = 35 WHERE state_ab = '$statefour'";
	$result = send_sql($sql, $link, $database);
	
	$sql = "UPDATE $fourthplayer SET state_ad = 1 WHERE state_ab = '$statefour'";
	$result = send_sql($sql, $link, $database);
	
	$sql = "SELECT * FROM $fourthplayer";
	$result = send_sql($sql, $link, $database);
...
while($row = mysql_fetch_array($result)){
  ...
  document.location.href = "player1.php";
	...
	What state does player 4 want to start in?
	<input type='text' name='state4'><br>
