...
/*
	...
	$fourthplayer = $secondplayer;
	
	$fifthplayer = $firstplayer;
	$sixthplayer = $secondplayer;
	
	$seventhplayer = $firstplayer;
	$eighthplayer = $secondplayer;
	
	$ninthplayer = $firstplayer;
	$tenthplayer = $secondplayer;
	
	$eleventhplayer = $firstplayer;
	$twelfthplayer = $secondplayer;
...
$database = "criewer";
	...
	echo"The player to go second is $secondplayer <br>";
