...
//Put end state check here
	$sql = "SELECT player_name FROM final WHERE id=4";
...
if($result && mysql_num_rows($result)>0){
	...
	if($ElectoralVotes >= 270 || $Locked == 50 ){
		...
		$sql = "SELECT player_name FROM final WHERE id=3";
		$result = send_sql($sql, $link, $db);
	
		//If player 3 exists it will be player one
			if($result &&  mysql_num_rows($result)>0){
		...
		//Maybe just drop table 3 and 4 even if they arent there and dont care.
			...
			$playerthree = $player3[0]; 
				...
				//player 2 needs to be checked for win state
						$sql = "SELECT player_name FROM final WHERE id=2";
						$result = send_sql($sql, $link, $db);
...
if($rownum > 0){
	...
	$sql = "SELECT donations FROM final WHERE id = 4";
	$result1 = send_sql($sql, $link, $db);
...
if($AdLevel > 0){
	if($donations >= $cost){
		...
		$sqlUD = "UPDATE final SET donations = donations - $cost WHERE id = 4";
		...
		if($adlevel > 10){
			...
			if($adlevel == 20){
				echo"You have been refunded 1000 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 1000 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 19){
				echo"You have been refunded 900 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 900 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 18){
				echo"You have been refunded 800 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 800 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 17){
				echo"You have been refunded 700 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 700 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 16){
				echo"You have been refunded 600 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 600 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 15){
				echo"You have been refunded 500 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 500 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 14){
				echo"You have been refunded 400 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 400 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 13){
				echo"You have been refunded 300 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 300 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 12){
				echo"You have been refunded 200 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 200 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 11){
				echo"You have been refunded 100 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 100 WHERE id = 4";
						$UD = send_sql($sqlUD, $link, $db);
...
//Locking in check.
		...
		$sql1 = "SELECT donations FROM final WHERE player_name = '$playername'";
...
if($DonationAmount >= 1000 && $StateInfluence >= 100){
	...
	$sql = ("SELECT id, player_name, donations, num_locked, cur_state, home_state FROM final WHERE id = 4");
...
//If 3 is there it will be player 1's turn

else{
	
	$sql = ("SELECT id, player_name, donations, num_locked, cur_state, home_state FROM final WHERE id = 3");
	$res = send_sql($sql, $link, $db);
if($res){	
...
//Otherwise player 2's turn
	...
	$sql = "SELECT donations FROM final WHERE id = 2";
	$result = send_sql($sql, $link, $db);
...
if($AdLevel > 0){
	if($donations >= $cost){
		...
		$sqlUD = "UPDATE final SET donations = donations - $cost WHERE id = 2";
		$UD = send_sql($sqlUD, $link, $db);
		...
		if($adlevel > 10){
			...
			if($adlevel == 20){
				echo"You have been refunded 1000 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 1000 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 19){
				echo"You have been refunded 900 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 900 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 18){
				echo"You have been refunded 800 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 800 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 17){
				echo"You have been refunded 700 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 700 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 16){
				echo"You have been refunded 600 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 600 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 15){
				echo"You have been refunded 500 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 500 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 14){
				echo"You have been refunded 400 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 400 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 13){
				echo"You have been refunded 300 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 300 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 12){
				echo"You have been refunded 200 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 200 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
			...
			if($adlevel == 11){
				echo"You have been refunded 100 dollars<br>";
						...
						$sqlUD = "UPDATE final SET donations = donations + 100 WHERE id = 2";
						$UD = send_sql($sqlUD, $link, $db);
	...
	echo"<br>Sorry, you did not have enough donations to by that ad level.<br>";
}
}
}else{
	echo"Your ad level is already 10!<br>";
...
if($DonationAmount >= 1000 && $StateInfluence >= 100){
	...
	$sql = ("SELECT id, player_name, donations, num_locked, cur_state, home_state FROM final WHERE id = 2");
	$res = send_sql($sql, $link, $db);
	while($row = mysql_fetch_array($res)){
	 echo"<tr>";
	 echo"<th> Player ID </th>";
...
<span id="picSpot">
	...
	btn.disabled = true;
		...
		echo "Remember, each level costs 100 dollars, i.e. level 4 will cost 400 dollars";
		echo "Enter in the level: ";
		echo "<input type='text' name='AdLevel'>";
		...
		$sql1 = "SELECT donations FROM final WHERE id = '$playername'";
		$result1 = send_sql($sql1, $link, $db);
		$donations  = mysql_fetch_array($result1);
		$DonationAmount = $donations[0];
